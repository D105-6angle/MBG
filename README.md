...
| <b>이름</b> | 김지현 |
| <b>나이</b> | 32세 |
| <b>현재 상황</b> | 학생들의 낮은 참여도와 지루함, 실시간 관리의 어려움을 겪고 있음. 사진 인증 방식이 번거롭고, 안전 및 일정 관리도 효율적으로 운영하기 어려움. |
| <b>목표 및 니즈</b> | 학생들의 흥미를 유도하고 학습 효과를 높일 수 있는 방법이 필요함. 보다 더 간편한 인증 방식과 일정·안전 관리를 위한 효율적인 도구가 있었으면 함. |  
...
| 01.16 | 컨설턴트 코치님 2차 미팅,요구사항 명세 논의 | 문방구 와이어 프레임 기획      | AI, AR 기술 적용을 위한 학습 | 생성형 AI를 이용한 캐릭터 디자인 | 문방구 와이어 프레임 기획     | 문방구 와이어 프레임 기획       | 요구사항 명세서 작성                            |
